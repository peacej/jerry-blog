...
BLOG_AUTHOR = "Jerry Chi"  # (translatable)
BLOG_TITLE = "Jerry Chi's website"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://jerrychi.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://jerrychi.com/"
BLOG_EMAIL = "jerrychi123@gmail.com"
BLOG_DESCRIPTION = "The awesomeest site"  # (translatable)
...
THEME = "cosmo" # https://bootswatch.com/cosmo/
